...
# Heavy diagnostics is operator-triggered; default TTL 0 avoids identical rows while
# generated_at advances after TTL expiry. Set MARKET_BREAKDOWN_CACHE_TTL_SEC=30 to re-enable.
_TTL_SEC = float(os.getenv("MARKET_BREAKDOWN_CACHE_TTL_SEC", "0"))
