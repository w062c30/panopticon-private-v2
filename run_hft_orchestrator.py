...
PROCESS_VERSION = "v1.1.40-D160"   # ← AGENT: bump on every change  # D133: Debt-1 fix — _on_insider_alert uses ShadowDB.conn instead of bare sqlite3.connect  # D158-2: signal_queue bounded maxsize=500 (backpressure vs unbounded growth)  # D159: sprint tag sync  # D160: PROCESS_VERSION bump only (logic unchanged in this file)
